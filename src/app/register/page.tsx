  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="relative z-10 bg-black/60 backdrop-blur-2xl border border-white/20 p-10 rounded-3xl shadow-2xl w-full max-w-md mx-4">
        ...
        <h1 className="text-3xl font-heading font-bold text-white mb-2">Join Lumina</h1>
        <p className="text-white/60 text-sm mb-8">Create an account to study with friends and save your progress across devices.</p>

        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="block text-white text-xs font-medium mb-1.5 uppercase tracking-wider">Username</label>
            <input 
              type="text" 
              required
              value={name}
